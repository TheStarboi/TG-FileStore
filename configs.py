...
class Config(object):
	...
	BOT_USERNAME = os.environ.get("BOT_USERNAME", "Tanya_robot_bot")
	DB_CHANNEL = int(os.environ.get("DB_CHANNEL", "-1002376548013"))
	SHORTLINK_URL = os.environ.get('SHORTLINK_URL', "0")
	SHORTLINK_API = os.environ.get('SHORTLINK_API', "0")
	BOT_OWNER = int(os.environ.get("BOT_OWNER", "6088500327"))
	DATABASE_URL = os.environ.get("DATABASE_URL", "mongodb+srv://dbmongo568:f9j54thSqaOnHDtY@cluster0.kwl70.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
